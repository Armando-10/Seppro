...
@Component({
  ...
  styles: [`
    ...
    .auth-header h1 { font-size: 1.6rem; color: #0F172A; margin-bottom: 6px; }
    ...
    .auth-success {
      margin-top: 16px; padding: 12px;
      background: rgba(0,114,198,0.1); border: 1px solid rgba(0,114,198,0.2);
      border-radius: 10px; color: #0072c6; text-align: center; font-size: 0.85rem;
    }
...
export class RegistroComponent {
  ...
  async onRegister() {
    ...
    this.success = '';
    try {
      await this.supabase.signUp(this.email, this.password, this.nombre, this.pin);
